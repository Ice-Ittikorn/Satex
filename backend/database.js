            ...
            `, (err) => {
              if (err) {
                ...
                let stmt3 = db.prepare(`
                  ...
                  VALUES (?,?,?,?,?,?,?,?,?)
                `);
                stmt3.run('สเต็กหมู', 'Pork Steak','4', "179", 'ทำจากหมูคุณภาพเลี้ยงด้วยลูกระเบิด', 'สันคอหมู,เกลือ,พริกไทยดำ,ซอสหมัก,เนย,กระเทียม,โรสแมรี่,มันฝรั่งทอด,สลัด', 'ย่าง', 'สเต็ก', "/uploads/1921Pork.jpeg", (err) => {
                  if (err) {
...
stmt3.run('สเต็กไก่','Chicken Steak', '3', "169", 'ทำจากไก่ที่เลี้ยงด้วยกระสุนจากอัฟกานิสถาน', 'เนื้ออกไก่,ซอสหมัก,เกลือ,พริกไทย,น้ำมันมะกอก,สลัด,ซอสพริกไทยดำ', 'ทอด ย่าง', 'สต็ก', "/uploads/1927Chicken.jpg", (err) => {
                ...
                stmt3.run('มันบด','Mashed potatoes', '8', "68", 'มันที่ปลูกด้วยสารเคมี x', 'มันฝรั่ง,เนย,นมสด,เกลือ,พริกไทยขาว', 'บด', 'อาหารทานเล่น', "/uploads/2007มันบด", (err) => {
                  if (err) {
                    console.error(err.message);
                  } else {
                    console.log("เพิ่มเมนูเสร็จสิ้น");
...
stmt3.run('เฟรนฟราย','Frenแ้ fireห', '10', "52", 'สั่งตรงมาจากอเมริกา', 'มันฝรั่ง,น้ำมันพืช,เกลือ', 'ทอด', 'อาหารทานเล่น', "/uploads/2008เฟรนฟราย", (err) => {
                  if (err) {
                    console.error(err.message);
                  } else {
                    console.log("เพิ่มเมนูเสร็จสิ้น");
                ...
                stmt3.run('นักเกตไก่','Chicken nuggets', '10', "69", 'สั่งตรงมาจากอเมริกา', 'เนื้อไก่บด,เกล็ดขนมปัง,แป้งสาลี,ไข่ไก่,เกลือ,พริกไทย,น้ำมันพืช', 'ทอด', 'อาหารทานเล่น', "/uploads/2009นักเกตไก่", (err) => {
                  if (err) {
                    console.error(err.message);
                  } else {
                    console.log("เพิ่มเมนูเสร็จสิ้น");
                ...
                stmt3.run('สลัด','Salad', '10', "72", 'ปลูกด้วยสารเคมี y', 'ผักกาดหอม.มะเขือเทศเชอรี่,แตงกว่า,หัวหอมใหญ่,แครอท,น้ำสลีด', 'ผัด', 'อาหารทานเล่น', "/uploads/2010สลัด", (err) => {
                  if (err) {
                    console.error(err.message);
                  } else {
                    console.log("เพิ่มเมนูเสร็จสิ้น");
...
stmt3.run('ชาใต้','Chatai', '10', "35", 'สั่งตรงมาจากภาคใต้', 'น้ำแข็ง,ชาใต้,นม', 'ชง', 'เครื่องดื่ม', "/uploads/2011ชาใต้", (err) => {
                  if (err) {
                    console.error(err.message);
                  } else {
                    console.log("เพิ่มเมนูเสร็จสิ้น");
                ...
                stmt3.run('โค้ก','Coke', '10', "20", 'สั่งตรงมาจากเตเนฮาปา', 'น้ำแข็ง,โค้ก', 'เทใส่แก้ว', 'เครื่องดื่ม', "/uploads/2012Coke", (err) => {
                  if (err) {
                    console.error(err.message);
                  } else {
                    console.log("เพิ่มเมนูเสร็จสิ้น");
                ...
                stmt3.run('น้ำส้ม','Orenge juice', '10', "25", 'ปลูกด้วยสารเคมี z', 'น้ำแข็ง,น้ำส้มคั้น', 'เทใส่แก้ว', 'เครื่องดื่ม', "/uploads/2026น้ำส้ม", (err) => {
                  if (err) {
                    console.error(err.message);
                  } else {
                    console.log("เพิ่มเมนูเสร็จสิ้น");
...
stmt3.run('น้ำเปล่า','Water', '10', "10", 'เป็นน้ำที่ส่งตรงมาจากเถือกเขาเอเวอเรส', 'น้ำ', 'เทใส่แก้ว', 'เครื่องดื่ม', "/uploads/2013Water", (err) => {
                  if (err) {
                    console.error(err.message);
                  } else {
                    console.log("เพิ่มเมนูเสร็จสิ้น");
                ...
                stmt3.run('น้ำแข็ง','Ice', '100', "5", 'น้ำแข็งที่ทำมาจากก้อนน้ำแข็งที่ขั้วโลกใต้', 'น้ำแข็ง', 'ทุบ', 'เครื่องดื่ม', "/uploads/2014น้ำแข็ง", (err) => {
                  if (err) {
                    console.error(err.message);
                  } else {
                    console.log("เพิ่มเมนูเสร็จสิ้น");
